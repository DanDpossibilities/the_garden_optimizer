...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference("Garden.count") do
      post gardens_url, params: { garden: { garden_name: @garden.garden_name, greenhouse: @garden.greenhouse, public: @garden.public, start_date: @garden.start_date } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { garden_name: @garden.garden_name, greenhouse: @garden.greenhouse, public: @garden.public, start_date: @garden.start_date } }
